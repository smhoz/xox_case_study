...
extension PaddingExtensionAll on BuildContext {
  ...
  EdgeInsets get paddingDisplay => EdgeInsets.all(displayValue);
...
extension PaddingExtensionSymetric on BuildContext {
  ...
  EdgeInsets get paddingDisplayhorizontal => EdgeInsets.symmetric(horizontal: displayValue);
  ...
  EdgeInsets get paddingMediumHorizontalAndVertical =>
      EdgeInsets.symmetric(horizontal: lowValue, vertical: lowValue / 2);

  EdgeInsets get paddingLowAndOnlyBottomBarPadding =>
      EdgeInsets.only(top: lowValue, left: lowValue, right: lowValue, bottom: bottomBarValue);

  EdgeInsets get onlyBottomBarPadding => EdgeInsets.only(bottom: bottomBarValue);
}
